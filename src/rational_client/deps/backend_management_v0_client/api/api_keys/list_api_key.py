...
def _get_kwargs(
    *,
    offset: int | Unset = 0,
    limit: int | Unset = 20,
    sorting: list[ListApiKeySortingItem] | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ApiKeyDtoPage | HttpValidationProblemDetails | ProblemDetails | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiKeyDtoPage | HttpValidationProblemDetails | ProblemDetails]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sorting (list[ListApiKeySortingItem] | Unset):
...
def sync(
    *,
    ...
    Returns:
        ApiKeyDtoPage | HttpValidationProblemDetails | ProblemDetails
    """
