...
) -> HttpValidationProblemDetails | ProblemDetails | list[ExtensionManifestDto] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HttpValidationProblemDetails | ProblemDetails | list[ExtensionManifestDto]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HttpValidationProblemDetails | ProblemDetails | list[ExtensionManifestDto]
    """
