...
def _get_kwargs(
    *,
    ...
    offset: int | Unset = 0,
    limit: int | Unset = 20,
    sorting: list[ListTouchpointSortingItem] | Unset = UNSET,
) -> dict[str, Any]:
...
) -> HttpValidationProblemDetails | ProblemDetails | TouchpointDtoPage | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HttpValidationProblemDetails | ProblemDetails | TouchpointDtoPage]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sorting (list[ListTouchpointSortingItem] | Unset):
...
def sync(
    *,
    ...
    Returns:
        HttpValidationProblemDetails | ProblemDetails | TouchpointDtoPage
    """
