...
class UpdateMcpServerToolRequest:
    ...
    Attributes:
        enabled (bool | Unset):
        default_configuration (UpdateMcpServerToolRequestDefaultConfiguration | Unset):
    """

    enabled: bool | Unset = UNSET
    default_configuration: UpdateMcpServerToolRequestDefaultConfiguration | Unset = UNSET

    def to_dict(self) -> dict[str, Any]:
        enabled = self.enabled

        default_configuration: dict[str, Any] | Unset = UNSET
