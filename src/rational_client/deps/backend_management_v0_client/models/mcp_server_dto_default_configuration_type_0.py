...
T = TypeVar("T", bound="McpServerDtoDefaultConfigurationType0")


@_attrs_define
class McpServerDtoDefaultConfigurationType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        mcp_server_dto_default_configuration_type_0 = cls()
        ...
        mcp_server_dto_default_configuration_type_0.additional_properties = additional_properties
        return mcp_server_dto_default_configuration_type_0
