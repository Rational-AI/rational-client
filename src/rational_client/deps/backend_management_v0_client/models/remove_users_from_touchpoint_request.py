...
T = TypeVar("T", bound="RemoveUsersFromTouchpointRequest")


@_attrs_define
class RemoveUsersFromTouchpointRequest:
    """
    Attributes:
        user_ids (list[UUID]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remove_users_from_touchpoint_request = cls(
            user_ids=user_ids,
        )

        return remove_users_from_touchpoint_request
