...
class TopicConfigurationDto:
    ...
    Attributes:
        ...
        labels (list[TopicLabel] | None | Unset):
    """
    ...
    labels: list[TopicLabel] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_labels(data: object) -> list[TopicLabel] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[TopicLabel] | None | Unset, data)
