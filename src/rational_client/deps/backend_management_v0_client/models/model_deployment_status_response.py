...
class ModelDeploymentStatusResponse:
    ...
    Attributes:
        ...
        conditions (list[KnativeCondition] | None | Unset):
        error_message (None | str | Unset):
        last_updated_at (datetime.datetime | None | Unset):
        active_revision (None | str | Unset):
    """
    ...
    conditions: list[KnativeCondition] | None | Unset = UNSET
    error_message: None | str | Unset = UNSET
    last_updated_at: datetime.datetime | None | Unset = UNSET
    active_revision: None | str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_conditions(data: object) -> list[KnativeCondition] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[KnativeCondition] | None | Unset, data)
        ...
        def _parse_active_revision(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
