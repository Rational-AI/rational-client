...
class SupportedModelDto:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_model_card(data: object) -> None | str | Unset:
            if data is None:
                return data
        ...
        def _parse_number_of_params(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
