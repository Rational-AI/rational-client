...
from ...models.bulk_delete_operation_request import BulkDeleteOperationRequest
...
def _get_kwargs(
    ...
    resource_id: UUID,
    *,
    body: BulkDeleteOperationRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/knowledge/v0/knowledge/{knowledge_id}/resources/{resource_id}/annotation/bulk-delete".format(
