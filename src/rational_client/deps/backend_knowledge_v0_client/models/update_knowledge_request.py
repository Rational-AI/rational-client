...
class UpdateKnowledgeRequest:
    ...
    Attributes:
        ...
        knowledge_sources (list[KnowledgeSourceConfigUpdate] | Unset):
        allow_ai_search (bool | Unset):
        allow_keywords_extraction (bool | Unset):
    ...
    knowledge_sources: list[KnowledgeSourceConfigUpdate] | Unset = UNSET
    allow_ai_search: bool | Unset = UNSET
    allow_keywords_extraction: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        knowledge_sources: list[dict[str, Any]] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        knowledge_sources: list[KnowledgeSourceConfigUpdate] | Unset = UNSET
        if _knowledge_sources is not UNSET:
            knowledge_sources = []
