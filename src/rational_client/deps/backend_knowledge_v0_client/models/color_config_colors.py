...
T = TypeVar("T", bound="ColorConfigColors")


@_attrs_define
class ColorConfigColors:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color_config_colors.additional_properties = additional_properties
        return color_config_colors
