...
class SearchRequest:
    ...
    Attributes:
        ...
        annotation_ids (list[UUID] | None | Unset):
    ...
    annotation_ids: list[UUID] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        annotation_ids: list[str] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_annotation_ids(data: object) -> list[UUID] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
