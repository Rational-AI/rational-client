...
def _get_kwargs(
    *,
    ...
    mcp_server_ids: Union[Unset, list[UUID]] = UNSET,
    is_default: Union[Unset, bool] = UNSET,
    offset: Union[Unset, int] = 0,
    limit: Union[Unset, int] = 20,
    sorting: Union[Unset, list[ListMcpServerConfigurationSortingItem]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}

    params["query"] = query

    json_mcp_server_ids: Union[Unset, list[str]] = UNSET
...
) -> Optional[Union[HttpValidationProblemDetails, McpServerConfigurationDtoPage, ProblemDetails]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HttpValidationProblemDetails, McpServerConfigurationDtoPage, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        mcp_server_ids (Union[Unset, list[UUID]]):
        is_default (Union[Unset, bool]):
        offset (Union[Unset, int]):  Default: 0.
        limit (Union[Unset, int]):  Default: 20.
        sorting (Union[Unset, list[ListMcpServerConfigurationSortingItem]]):
...
def sync(
    *,
    ...
    Returns:
        Union[HttpValidationProblemDetails, McpServerConfigurationDtoPage, ProblemDetails]
    """
