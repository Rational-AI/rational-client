...
def _get_kwargs(
    *,
    ...
    sorting: Union[Unset, list[ListConnectorSortingItem]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ConnectorDtoPage, HttpValidationProblemDetails, ProblemDetails]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ConnectorDtoPage, HttpValidationProblemDetails, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sorting (Union[Unset, list[ListConnectorSortingItem]]):
...
def sync(
    *,
    ...
    Returns:
        Union[ConnectorDtoPage, HttpValidationProblemDetails, ProblemDetails]
    """
