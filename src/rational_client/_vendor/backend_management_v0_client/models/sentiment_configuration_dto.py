...
class SentimentConfigurationDto:
    ...
    Attributes:
        ...
        labels (Union[None, Unset, list['SentimentLabel']]):
    """
    ...
    labels: Union[None, Unset, list["SentimentLabel"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_labels(data: object) -> Union[None, Unset, list["SentimentLabel"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["SentimentLabel"]], data)
