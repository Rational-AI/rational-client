...
T = TypeVar("T", bound="RemoveUrsersFromGroupRequest")


@_attrs_define
class RemoveUrsersFromGroupRequest:
    """
    Attributes:
        user_ids (list[UUID]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remove_ursers_from_group_request = cls(
            user_ids=user_ids,
        )

        return remove_ursers_from_group_request
