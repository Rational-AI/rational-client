...
class CreateProxyRequest:
    ...
    Attributes:
        ...
        provider_base_url (Union[None, Unset, str]):
        track_usage (Union[None, Unset, bool]):
    """

    name: str
    description: Union[None, Unset, str] = UNSET
    connector_id: Union[None, UUID, Unset] = UNSET
    provider_base_url: Union[None, Unset, str] = UNSET
    track_usage: Union[None, Unset, bool] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_provider_base_url(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_track_usage(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
