...
class CreateKnowledgeRequest:
    ...
    Attributes:
        ...
        knowledge_sources (Union[None, Unset, list['KnowledgeSourceConfig']]):
        allow_ai_search (Union[None, Unset, bool]):
    ...
    knowledge_sources: Union[None, Unset, list["KnowledgeSourceConfig"]] = UNSET
    allow_ai_search: Union[None, Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        knowledge_sources: Union[None, Unset, list[dict[str, Any]]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_knowledge_sources(data: object) -> Union[None, Unset, list["KnowledgeSourceConfig"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["KnowledgeSourceConfig"]], data)

        knowledge_sources = _parse_knowledge_sources(d.pop("knowledgeSources", UNSET))

        def _parse_allow_ai_search(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
